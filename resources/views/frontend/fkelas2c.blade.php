...
<form class="" action="/carifkelas2c" method="GET" style="margin-right:190px ;">
        ...
        <div class='overflow-x-auto w-full'>
            ...
            <table class='mx-auto max-w-4xl w-full whitespace-nowrap rounded-lg bg-white divide-y divide-gray-300 overflow-hidden'>
                ...
                @foreach($fkelas2c as $fl)
                    <tr>
                        <td class="px-6 py-4">
                        
                            <div class="flex items-center space-x-3">
                                <div class="inline-flex w-10 h-10"> <img class='w-10 h-10 object-cover rounded-full' alt='User avatar' src='/image/{{$fl->image}}' /> </div>
                                <div>
                                    <p>{{$fl->nama}}</p>
                                </div>
                            </div>
                        ...
                        <td class="px-6 py-4 text-center">{{$fl->msoffice}}</td>
                        <td class="px-6 py-4 text-center">{{$fl->photoshop}}</td>
                        <td class="px-6 py-4 text-center">{{$fl->laravel}}</td>
                        @endforeach
                    </tr>
                </tbody>
            </table>
