...
<form class="" action="/carifkelas1a" method="GET" style="margin-right:190px ;">
            ...
            <table class='mx-auto max-w-4xl w-full whitespace-nowrap rounded-lg bg-white divide-y divide-gray-300 overflow-hidden'>
                <thead class="bg-gray-900">
                    <tr class="text-white text-left">
                        ...
                        <th class="font-semibold text-sm uppercase px-6 py-4">Laravel</th>
                    </tr>
                </thead>
                <tbody class="divide-y divide-gray-200">
                @foreach($fkelas1a as $fa)
                    <tr>
                        <td class="px-6 py-4">
                        
                            <div class="flex items-center space-x-3">
                                <div class="inline-flex w-10 h-10"> <img class='w-10 h-10 object-cover rounded-full' alt='User avatar' src='/image/{{$fa->image}}' /> </div>
                                <div>
                                    <p>{{$fa->nama}}</p>
                                </div>
                            </div>
                        ...
                        <td class="px-6 py-4 text-center">{{$fa->msoffice}}</td>
                        <td class="px-6 py-4 text-center">{{$fa->photoshop}}</td>
                        <td class="px-6 py-4 text-center">{{$fa->laravel}}</td>
                        @endforeach
                    </tr>
                </tbody>
            </table>
